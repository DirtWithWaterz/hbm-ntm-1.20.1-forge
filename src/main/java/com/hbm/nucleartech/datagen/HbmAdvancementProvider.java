...
public class HbmAdvancementProvider extends ForgeAdvancementProvider {
    ...
    public HbmAdvancementProvider(PackOutput pOutput, CompletableFuture<HolderLookup.Provider> pRegistries, ExistingFileHelper existingFileHelper) {
