...
public class AsbestosParticle extends TextureSheetParticle {

    private final SpriteSet sprites;

    protected AsbestosParticle(ClientLevel world, double x, double y, double z,
                               double dx, double dy, double dz, SpriteSet sprites) {
        super(world, x, y, z, dx, dy, dz);
        this.setSize(0.5F, 0.5F);
        this.lifetime = world.random.nextInt(200)+1;
        this.gravity = 0.0F;
