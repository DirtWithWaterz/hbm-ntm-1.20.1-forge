        ...
        if(event.phase == TickEvent.Phase.END) {
            ...
            for(Player p : level.players()) {
                ...
                for(ItemEntity i : items) {
                    ...
                    ContaminationUtil.radiate((ServerLevel) level, i.getOnPos().getX()+0.5, i.getOnPos().getY()+1, i.getOnPos().getZ()+0.5, 5, (float)(neutronRads*0.00004D-(0.00004D*20)), i.getOnPos().offset(0, 1, 0));
                }
            }
        }
    }
