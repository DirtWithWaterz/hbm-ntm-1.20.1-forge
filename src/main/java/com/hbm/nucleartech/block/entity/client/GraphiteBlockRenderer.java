...
public class GraphiteBlockRenderer extends GeoBlockRenderer<GraphiteBlockEntity> { // line 24

    public GraphiteBlockRenderer(BlockEntityRendererProvider.Context context) {
        super(new GraphiteBlockModel());
    }

    @Override
    public boolean shouldRenderOffScreen(GraphiteBlockEntity pBlockEntity) {
        return true;
    }
