...
public class ArmorModificationTableRenderer extends GeoBlockRenderer<ArmorModificationTableEntity> {

    public ArmorModificationTableRenderer(BlockEntityRendererProvider.Context context) {
        super(new ArmorModificationTableModel());
    }

    @Override
    public boolean shouldRenderOffScreen(ArmorModificationTableEntity pBlockEntity) {
        return true;
    }
